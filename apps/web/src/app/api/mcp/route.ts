// Same-origin proxy to the Oracle-Automate MCP server's HTTP transport.
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    target: TARGET,
    hint: 'POST a JSON-RPC 2.0 message to this endpoint to call the Oracle-Automate MCP server.',
  });
}
