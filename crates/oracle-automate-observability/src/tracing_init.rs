...
//!   - `OTEL_SERVICE_NAME`        — service name (default: `oracle-automate`).
...
//!
//! Real OTLP wiring lives in `apps/oracle-automate-server` behind a feature
...
pub fn init_default() {
    INIT.get_or_init(|| {
        ...
        // application binaries (apps/oracle-automate-server, ...).  This
